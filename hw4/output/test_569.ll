...
define i64 @program(i64 %_argc1055, { i64, [0 x i8*] }* %_argv1053) {
  ...
  store i64 1, i64* %_ind1059
  %_ind1060 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1058, i32 0, i32 1, i32 1
  store i64 2, i64* %_ind1060
  store { i64, [0 x i64] }* %_array1058, { i64, [0 x i64] }** @arr
  %_arr1061 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @arr
  %_index_ptr1063 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1061, i32 0, i32 1, i32 1
  %_index1064 = load i64, i64* %_index_ptr1063
  ret i64 %_index1064
}
