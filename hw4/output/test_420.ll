...
_body125:
  ...
  %_index_ptr130 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x127, i32 0, i32 1, i64 %_i128
  %_index131 = load i64, i64* %_index_ptr130
  %_x132 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x119
  %_i133 = load i64, i64* %_i121
  %_index_ptr135 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x132, i32 0, i32 1, i64 %_i133
  %_index136 = load i64, i64* %_index_ptr135
  %_unop137 = xor i64 %_index136, -1
  %_bop138 = mul i64 %_index131, %_unop137
  store i64 %_bop138, i64* %_ans120
  %_i139 = load i64, i64* %_i121
  %_bop140 = add i64 %_i139, 1
  store i64 %_bop140, i64* %_i121
  br label %_cond126
_post124:
  %_ans141 = load i64, i64* %_ans120
  ret i64 %_ans141
}
